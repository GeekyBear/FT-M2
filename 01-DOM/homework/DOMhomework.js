...
createdBy.innerHTML += ' Ezequiel'

var title = document.querySelector('h1')
title.innerHTML = "Aplicacion To-Do"
...
function buildToDos(toDos) {
  // Tu código acá:
  //var values = toDos.map((item, index) => buildToDo(item,index))
  
  //var elemento = 

  return toDos.map(function(item, index) {
    // Aplico a cada elemento buildToDo y le paso item e index
